...
var IndesisionApp = function (_React$Component) {
    ...
    function IndesisionApp() {
        ...
        return _possibleConstructorReturn(this, (IndesisionApp.__proto__ || Object.getPrototypeOf(IndesisionApp)).apply(this, arguments));
    }

    _createClass(IndesisionApp, [{
        key: 'render',
        value: function render() {
            var title = 'Indesision';
            var subtitle = 'Put you life in the hands of a computer';
            var options = ['Things one', 'Thing two', 'Thing three'];
